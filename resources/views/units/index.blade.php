        ...
        <div class="col-12 col-lg-12">
          <div class="card">
            ...
            <div class="d-flex justify-content-center pb-5">
              ...
              {{-- {{ $units->links() }} --}}
              <?php $next_text = 'Next »'; $next_page = $units->current_page + 1; ?>
              <?php $prev_text = '« Previous'; $prev_page = $units->current_page - 1; ?>
              @if ($units->last_page > 1)
              <nav role="navigation" aria-label="Pagination Navigation" class="flex justify-between">
                  {{-- Previous Page Link --}}
                  @if ($units->prev_page_url == null)
