        ...
        <div class="col-12 col-lg-12">
          <div class="card">
            <div class="row pt-4">
              ...
              <div class="col-12 col-lg-12 py-3 px-5">
                <form action="{{ (isset($question_category)) ? url('questions_categories/'.$question_category->id) : url('questions_categories') }}" method="post" enctype="multipart/form-data" id="form">
                    @csrf
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-8 col-lg-8">
                            ...
                            is-invalid
                            @enderror" value="{{ (old('name') != null) ? old('name') : (isset($question_category) ? $question_category->name : '') }}" required autofocus>
                            @error('name')
                ...
                <div class="row py-5">
                    ...
                    <div class="col-6 col-lg-6">
                        <button form="form" class="btn btn-primary bg-gradient-primary form-control text-uppercase fw-bold" role="button">{{ (isset($question_category)) ? 'perbarui' : 'buat' }}</button>
                    </div>
                </div>
