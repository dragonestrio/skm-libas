        ...
        <div class="col-12 col-lg-12">
          <div class="card">
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      @foreach ($question_category->data as $item)
                      <tr class="fw-bolder">
            ...
            <div class="d-flex justify-content-center pb-5">
              ...
              <?php $next_text = 'Next »'; $next_page = $question_category->current_page + 1; ?>
              <?php $prev_text = '« Previous'; $prev_page = $question_category->current_page - 1; ?>
              @if ($question_category->last_page > 1)
              <nav role="navigation" aria-label="Pagination Navigation" class="flex justify-between">
                  {{-- Previous Page Link --}}
                  @if ($question_category->prev_page_url == null)
                  ...
                  {{-- Next Page Link --}}
                  @if ($question_category->next_page_url != null)
