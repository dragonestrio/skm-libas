          ...
          <div class="card">
            <div class="row pt-4">
              ...
              <div class="col-12 col-lg-12 pb-3 px-5">
                <a href="{{ url('reports/create') }}" class="form-control btn btn-primary bg-gradient-primary mb-0">
                      ...
                      <tr class="fw-bolder">
                        ...
                        <td>
                          <div class="d-flex justify-content-center">
                            ...
                            <a href="{{ url('reports/'.$item->id.'/edit') }}" class="btn shadow-none text-decoration-none fw-bold px-3 py-0">
                              <div class="input-group">
