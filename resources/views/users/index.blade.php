          ...
          <div class="card">
            <div class="row pt-4">
              ...
              <div class="col-12 col-lg-12 pb-3 px-5">
                <a href="{{ url('users/create') }}" class="form-control btn btn-primary bg-gradient-primary mb-0">
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      @if ($item->level == 'admin' || $item->level == 'superadmin')
                      <tr class="fw-bolder">
                        <td class="text-capitalize px-4">{{ $item->name }}</td>
                        <td class="text-lowercase">{{ $item->email }}</td>
                        <td>
                          <div class="d-flex justify-content-center">
                            <a href="{{ url('users/'.$item->id) }}" class="btn shadow-none text-decoration-none fw-bold px-3 py-0">
                              <div class="input-group">
                            ...
                            <a href="{{ url('users/'.$item->id.'/edit') }}" class="btn shadow-none text-decoration-none fw-bold px-3 py-0">
                              <div class="input-group">
                            ...
                            <button form="delete-{{ $item->id }}" onclick="return confirm('Apakah benar Anda ingin menghapus Admin {{ $item->name }} ?')" class="btn shadow-none fw-bold px-3 py-0">
                              <form action="{{ url('users/'.$item->id) }}" method="post" enctype="multipart/form-data" class="d-inline" id="delete-{{ $item->id }}">
                                @method('delete')
                                @csrf
                                <div class="input-group">
