          ...
          <div class="card">
            <div class="row pt-4">
              ...
              <div class="col-12 col-lg-12 pb-3 px-5">
                <a href="<?php echo e(url('questions_categories/create')); ?>" class="form-control btn btn-primary bg-gradient-primary mb-0">
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <?php $__currentLoopData = $question_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr class="fw-bolder">
                        <td class="text-capitalize px-4"><?php echo e($item->name); ?></td>
                        <td>
                          <div class="d-flex justify-content-center">
                            
                            <a href="<?php echo e(url('questions_categories/'.$item->id.'/edit')); ?>" class="btn shadow-none text-decoration-none fw-bold px-3 py-0">
                              <div class="input-group">
                            ...
                            <button form="delete-<?php echo e($item->id); ?>" onclick="return confirm('Apakah benar Anda ingin menghapus Admin <?php echo e($item->name); ?> ?')" class="btn shadow-none fw-bold px-3 py-0">
                              <form action="<?php echo e(url('questions_categories/'.$item->id)); ?>" method="post" enctype="multipart/form-data" class="d-inline" id="delete-<?php echo e($item->id); ?>">
            ...
            <div class="d-flex justify-content-center pb-5">
              ...
              <?php echo e($question_category->links()); ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/satrionugroho/Sites/localhost/skm_libas/resources/views/question_category/index.blade.php ENDPATH**/ ?>