          ...
          <div class="card">
            <div class="row pt-4">
              ...
              <div class="col-12 col-lg-12 pb-3 px-5">
                <a href="<?php echo e(url('users/create')); ?>" class="form-control btn btn-primary bg-gradient-primary mb-0">
              ...
              <div class="col-12 col-lg-12 py-3">
                <div class="table-responsive">
                  <table class="table">
                    <thead>
                      <tr>
                        <th class="text-capitalize text-xxs text-start">nama lengkap</th>
                        <th class="text-capitalize text-xxs text-center">email</th>
                    ...
                    <tbody>
                      ...
                      <?php if($item->level == 'admin' || $item->level == 'superadmin'): ?>
                      <tr class="fw-bolder">
                        <td class="text-capitalize px-4"><?php echo e($item->name); ?></td>
                        <td class="text-lowercase"><?php echo e($item->email); ?></td>
                        <td>
                          <div class="d-flex justify-content-center">
                            <a href="<?php echo e(url('users/'.$item->id)); ?>" class="btn shadow-none text-decoration-none fw-bold px-3 py-0">
                              <div class="input-group">
                            ...
                            <a href="<?php echo e(url('users/'.$item->id.'/edit')); ?>" class="btn shadow-none text-decoration-none fw-bold px-3 py-0">
                              <div class="input-group">
                            ...
                            <button form="delete-<?php echo e($item->id); ?>" onclick="return confirm('Apakah benar Anda ingin menghapus Admin <?php echo e($item->name); ?> ?')" class="btn shadow-none fw-bold px-3 py-0">
                              <form action="<?php echo e(url('users/'.$item->id)); ?>" method="post" enctype="multipart/form-data" class="d-inline" id="delete-<?php echo e($item->id); ?>">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/satrionugroho/Sites/localhost/skm_libas/resources/views/users/index.blade.php ENDPATH**/ ?>