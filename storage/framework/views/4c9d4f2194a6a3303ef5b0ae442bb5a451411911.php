                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="nav-link dropdown-large">
                                ...
                                <?php if(isset($menu)): ?>  
                                <div id="menu" class="table-responsive dropdown-menu dropdown-menu-dark slidedown-animate bg-dark border-0 rounded-0 p-0 m-0 start-0 w-100 h-100 h-lg-auto zindex-01 shadow">
...
</nav><?php /**PATH /Users/satrionugroho/Sites/localhost/laravela/resources/views/partials/navbar/fixed.blade.php ENDPATH**/ ?>