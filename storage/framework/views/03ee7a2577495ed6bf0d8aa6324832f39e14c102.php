        ...
        <div class="col-12 col-lg-12">
          <div class="card">
            <div class="row pt-4">
              ...
              <div class="col-12 col-lg-12 py-3 px-5">
                <form action="<?php echo e((isset($question)) ? url('questions/'.$question->id) : url('questions')); ?>" method="post" enctype="multipart/form-data" id="form">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-8 col-lg-8">
                            <select name="questions_categorie_id" class="form-control <?php $__errorArgs = ['questions_categorie_id'];
...
unset($__errorArgs, $__bag); ?>">
                              <?php if(old('questions_categorie_id') != null): ?>
                                <?php $__currentLoopData = $questions_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($item->id == old('questions_categorie_id')): ?>
                                    <option value="<?php echo e(old('questions_categorie_id')); ?>"><?php echo e(ucwords($item->name)); ?></option>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              <?php else: ?>
                                <?php if(isset($question)): ?>
                                  <?php $__currentLoopData = $questions_category; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <?php if($item->id == $question->questions_categorie_id): ?>
                            ...
                            <?php $__errorArgs = ['questions_categorie_id'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e((old('name') != null) ? old('name') : (isset($question) ? $question->name : '')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row py-5">
                    ...
                    <div class="col-6 col-lg-6">
                        <button form="form" class="btn btn-primary bg-gradient-primary form-control text-uppercase fw-bold" role="button"><?php echo e((isset($question)) ? 'perbarui' : 'buat'); ?></button>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/satrionugroho/Sites/localhost/skm_libas/resources/views/question/form.blade.php ENDPATH**/ ?>