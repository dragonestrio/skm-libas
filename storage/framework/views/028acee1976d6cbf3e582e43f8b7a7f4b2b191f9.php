        ...
        <div class="col-12 col-lg-12">
          <div class="card">
            <div class="row pt-4">
              ...
              <div class="col-12 col-lg-12 py-3 px-5">
                <form action="<?php echo e((isset($units)) ? url('units/'.$units->id) : url('units')); ?>" method="post" enctype="multipart/form-data" id="form">
                    <?php echo csrf_field(); ?>
                    <?php if(isset($units)): ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e((old('name') != null) ? old('name') : (isset($units) ? $units->name : '')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row py-5">
                    ...
                    <div class="col-6 col-lg-6">
                        <button form="form" class="btn btn-primary bg-gradient-primary form-control text-uppercase fw-bold" role="button"><?php echo e((isset($units)) ? 'perbarui' : 'buat'); ?></button>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/satrionugroho/Sites/localhost/skm_libas/resources/views/units/form.blade.php ENDPATH**/ ?>