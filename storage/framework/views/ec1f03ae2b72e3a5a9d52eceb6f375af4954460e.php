...
<script>
  ...
  const showListExam = Exams => {
    listExam.innerHTML = "";
        listExam.innerHTML += `
        <h4 class="mb-4">KATEGORI : ${Exams.questions_categorie_name}</h4>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/satrionugroho/Sites/localhost/skm_libas/resources/views/frontend/exams-new.blade.php ENDPATH**/ ?>