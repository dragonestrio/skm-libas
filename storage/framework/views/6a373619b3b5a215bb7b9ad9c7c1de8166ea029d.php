          ...
          <div class="card">
            <div class="row pt-4">
              ...
              <div class="col-12 col-lg-12 pb-3 px-5">
                <a href="<?php echo e(url('questions/create')); ?>" class="form-control btn btn-primary bg-gradient-primary mb-0">
                  ...
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <tr class="fw-bolder">
                        ...
                        <td class="text-capitalize px-4"><?php echo e($item->questions_categorie_name); ?></td>
                        <td>
                          <div class="d-flex justify-content-center">
                            
                            <a href="<?php echo e(url('questions/'.$item->id.'/edit')); ?>" class="btn shadow-none text-decoration-none fw-bold px-3 py-0">
                              <div class="input-group">
                            ...
                            <button form="delete-<?php echo e($item->id); ?>" onclick="return confirm('Apakah benar Anda ingin menghapus Admin <?php echo e($item->name); ?> ?')" class="btn shadow-none fw-bold px-3 py-0">
                              <form action="<?php echo e(url('questions/'.$item->id)); ?>" method="post" enctype="multipart/form-data" class="d-inline" id="delete-<?php echo e($item->id); ?>">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/satrionugroho/Sites/localhost/skm_libas/resources/views/question/index.blade.php ENDPATH**/ ?>