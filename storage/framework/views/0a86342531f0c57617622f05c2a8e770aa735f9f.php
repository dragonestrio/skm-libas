                    ...
                    <div class="container">
                        <div class="py-2">
                            <div class="container py-3 rounded-3">
                                ...
                                <div class="py-3">
                                    <a href="<?php echo e(url('mhs/create')); ?>" class="btn btn-success form-control text-decoration-none text-center text-uppercase fw-bold shadow">tambah/buat data baru</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row py-5">
                            ...
                            <div class="col-12 col-lg-6 py-2 shadow">
                                <a href="<?php echo e(url('mhs/'.$item->id.'/edit')); ?>" class="text-decoration-none text-white">
                                    <div class="container py-3 btn-animate rounded-3 shadow">
                                        <div class="row">
                                            <div class="col-12 col-lg-12 border-1 border-bottom">
                                                <p class="p-0 m-0 text-center text-truncate"><?php echo e($item->nim); ?></p>
                                            </div>
                                            ...
                                            <div class="col-12 col-lg-12">
                                                <div class="row py-3">
                                                    <div class="col-6 col-lg-6">
                                                        <a href="<?php echo e(url('mhs/'.$item->id.'/edit')); ?>" class="form-control btn btn-success text-decoration-none text-uppercase fw-bold">edit</a>
                                                    </div>
                                                    <div class="col-6 col-lg-6">
                                                        <form action="<?php echo e(url('mhs/'. $item->id)); ?>" method="post" enctype="multipart/form-data" class="d-inline">
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/satrionugroho/Sites/localhost/can_a/resources/views/mhs/index.blade.php ENDPATH**/ ?>