        ...
        <div class="col-12 col-lg-12">
          <div class="card">
            <div class="row pt-4">
              ...
              <div class="col-12 col-lg-12 py-3 px-5">
                <form action="<?php echo e((isset($respondent)) ? url('respondents/'.$respondent->id) : url('respondents')); ?>" method="post" enctype="multipart/form-data" id="form">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>">
                              <?php if(old('unit_id') != null): ?>
                                <?php $__currentLoopData = $unit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($item->id == old('unit_id')): ?>
                                    <option value="<?php echo e(old('unit_id')); ?>"><?php echo e(ucwords($item->name)); ?></option>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                              <?php else: ?>
                                <?php if(isset($respondent)): ?>
                                  <?php $__currentLoopData = $unit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <?php if($item->id == $respondent->unit_id): ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="row py-2">
                        ...
                        <div class="col-8 col-lg-8">
                            <input type="text" name="education" class="form-control <?php $__errorArgs = ['education'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e((old('education') != null) ? old('education') : (isset($respondent) ? $respondent->education : '')); ?>" required autofocus>
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="row py-5">
                    ...
                    <div class="col-6 col-lg-6">
                        <button form="form" class="btn btn-primary bg-gradient-primary form-control text-uppercase fw-bold" role="button"><?php echo e((isset($respondent)) ? 'perbarui' : 'buat'); ?></button>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/satrionugroho/Sites/localhost/skm_libas/resources/views/respondent/form.blade.php ENDPATH**/ ?>