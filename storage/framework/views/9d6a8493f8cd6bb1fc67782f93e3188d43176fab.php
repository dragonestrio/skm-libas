          ...
          <div class="card">
            <div class="row pt-4">
              ...
              <div class="col-12 col-lg-12 pb-3 px-5">
                <a href="<?php echo e(url('reports/create')); ?>" class="form-control btn btn-primary bg-gradient-primary mb-0">
                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      <?php $__currentLoopData = $report->data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr class="fw-bolder">
                        <td class="text-lowercase px-4"><?php echo e($item->units_name); ?></td>
                        <td class="text-capitalize px-4"><?php echo e($item->questions_name); ?></td>
                        <td class="text-capitalize px-4 text-center"><?php echo e($item->result); ?></td>
                        <td class="text-capitalize px-4 text-center"><?php echo e(date('d M Y, h:i:s', strtotime($item->created_at))); ?></td>
                        <td>
                          <div class="d-flex justify-content-center">
                            
                            <a href="<?php echo e(url('reports/'.$item->id.'/edit')); ?>" class="btn shadow-none text-decoration-none fw-bold px-3 py-0">
                              <div class="input-group">
                            ...
                            <button form="delete-<?php echo e($item->id); ?>" onclick="return confirm('Apakah benar Anda ingin menghapus Laporan <?php echo e($item->id); ?> ?')" class="btn shadow-none fw-bold px-3 py-0">
                              <form action="<?php echo e(url('reports/'.$item->id)); ?>" method="post" enctype="multipart/form-data" class="d-inline" id="delete-<?php echo e($item->id); ?>">
            ...
            <div class="d-flex justify-content-center pb-5">
              ...
              <?php if($report->last_page > 1): ?>
              <nav role="navigation" aria-label="Pagination Navigation" class="flex justify-between">
                  
                  <?php if($report->prev_page_url == null): ?>
                      <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-500 bg-white border border-gray-300 cursor-default leading-5 rounded-md">
                        <?php echo e($prev_text); ?>

                      </span>
                      <?php else: ?>
                      <a href="<?php echo e(url()->current().'?page='.$prev_page); ?>" rel="prev" class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 rounded-md hover:text-gray-500 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
                        <?php echo e($prev_text); ?>
                  ...
                  <?php if($report->next_page_url != null): ?>
                      <a href="<?php echo e(url()->current().'?page='.$next_page); ?>" rel="next" class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-gray-700 bg-white border border-gray-300 leading-5 rounded-md hover:text-gray-500 focus:outline-none focus:ring ring-gray-300 focus:border-blue-300 active:bg-gray-100 active:text-gray-700 transition ease-in-out duration-150">
                          <?php echo e($next_text); ?>
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/satrionugroho/Sites/localhost/skm_libas/resources/views/report/index.blade.php ENDPATH**/ ?>