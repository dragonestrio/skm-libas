<nav id="header" class="navbar navbar-expand-lg navbar-dark bg-dark shadow fixed-top">
    <div class="container-fluid">
        <div class="row w-25">
            <div class="col-12 col-lg-12">
                <a href="<?php echo e(url('/')); ?>" class="text-decoration-none">
                    <h5 class="text-uppercase fw-bold mx-0 px-0 mt-1"><?php echo e($app); ?></h5>
                </a>
            </div>
        </div>
        ...
        <div class="navbar-collapse collapse" id="navbar">
            <div class="row w-100 ps-3">
                ...
                <div class="col-12 col-lg-4 nav-item">
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            <a href="<?php echo e(url('register')); ?>" class="nav-link text-uppercase text-center text-lg-end text-white">
                                <p class="p-0 m-0 mt-2">buat cv</p>
                            </a>
                        </div>
                        <div class="col-12 col-lg-6">
                            <a href="<?php echo e(url('find')); ?>" class="nav-link text-uppercase text-center text-lg-center text-white">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-lg-5">
                            <div class="nav-link dropdown-large">
                                ...
                                <?php if(isset($menu)): ?>  
                                <div id="menu" class="table-responsive dropdown-menu dropdown-menu-dark dropdown-animate bg-dark border-0 rounded-0 p-0 m-0 start-0 w-100 h-100 h-lg-auto shadow">
                                    <div class="container-fluid pt-0 pt-lg-4 pb-4 pb-lg-5">
                                        <div class="row">
                                            <div class="col-12 col-lg-3">

                                                <?php if(in_array('a', $menu)): ?>
                                                ...
                                                <div class="row w-100 pt-2 text-center text-lg-end text-white">
                                                    <div class="col-12 col-lg-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-12">
                                                                <a href="<?php echo e(url('register')); ?>" class="btn btn-outline-secondary border-0 bg-transparent text-capitalize p-0">
                                                                    <h5 class="m-0">daftar baru</h5>
                                                                </a>
                                                            </div>
                                                            <div class="col-12 col-lg-12">
                                                                <a href="<?php echo e(url('login')); ?>" class="btn btn-outline-secondary border-0 bg-transparent text-capitalize p-0">
                                                    ...
                                                    <div class="col-12 col-lg-6">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-12 col-lg-12">
                                                                <a href="<?php echo e(url('profile')); ?>" class="btn btn-outline-secondary border-0 bg-transparent text-capitalize p-0">
                                                                    <h5 class="m-0">edit profile</h5>
                                                                </a>
                                                            </div>
                                                            <div class="col-12 col-lg-12">
                                                                <a href="<?php echo e(url('logout')); ?>" class="btn btn-outline-secondary border-0 bg-transparent text-capitalize p-0">
...
</nav><?php /**PATH D:\xampp\htdocs\laravela\resources\views/partials/navbar/fixed-navbar.blade.php ENDPATH**/ ?>