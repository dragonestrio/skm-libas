        ...
        <div class="btn-group row">
            ...
            <div >
              <label class="btn-radio">
                  <input onchange="gender('L')" type="radio" name="gender" required   />
                  <span>Laki - laki</span>
              </label>
              <label class="btn-radio">
                  <input onchange="gender('P')" type="radio" name="gender" />
                  <span>Perempuan</span>
                </label>
            </div>
        </div>
...
<script>
  ...
  const getalldata = () => {
    if (data.gender !== '' && data.education !== '' && data.unit_id !== '') {
        ...
        window.location.href = <?php echo '"'.url('exams').'"'; ?>
...
<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/satrionugroho/Sites/localhost/skm_libas/resources/views/frontend/index.blade.php ENDPATH**/ ?>